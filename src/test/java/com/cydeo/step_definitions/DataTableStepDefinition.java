...
public class DataTableStepDefinition {
    ...
    public void user_should_see_fruits_i_like(List<String> fruitList) {
    ...
    public void user_should_see_below_info_in_month_dropdown(List<String> expectedMonth) {
        ...
        Assert.assertEquals(expectedMonth,BrowserUtils.dropdownOptionsString(dropDownPages.selectMonth));
